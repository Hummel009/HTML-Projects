...
if (typeof (document.getElementById("findu")) != 'undefined' && document.getElementById("findu") != null) {
	document.getElementById("findu").onclick = function() {
		find()
	};
}
...
function find() {
	...
	if (x.includes("yakub")
		...
		|| x.includes("bahdanovich")
		|| x.includes("bohdanovich")
		|| x.includes("bahdanovicz")
		|| x.includes("bohdanovicz")
		|| x.includes("maxim")
		|| x.includes("maksim")
